        ...
        public void InserirEscola(string nomeDb, List<Escola> escolas)
        {
            ...
            try{
                foreach(Escola escola in escolas)
                {
                    ...
                    command.Parameters.AddWithValue("@Fax", escola.Fax.HasValue ? escola.Fax.Value : DBNull.Value);
                    ...
                    command.Parameters.AddWithValue("@CodInep", escola.CodInep.HasValue ? escola.CodInep.Value : DBNull.Value);
                    command.Parameters.AddWithValue("@Cd_Cie", escola.Cd_Cie.HasValue ? escola.Cd_Cie.Value : DBNull.Value);
                    command.Parameters.AddWithValue("@Eh", escola.Eh.HasValue ? escola.Eh.Value : DBNull.Value);
                    command.Parameters.AddWithValue("@Fx_Etaria", escola.Fx_Etaria);
                    command.Parameters.AddWithValue("@Dt_Criacao", escola.Dt_Criacao.HasValue ? escola.Dt_Criacao.Value : DBNull.Value);
                    command.Parameters.AddWithValue("@Ato_Criacao", escola.Ato_Criacao);
                    command.Parameters.AddWithValue("@Dom_Criacao", escola.Dom_Criacao.HasValue ? escola.Dom_Criacao.Value : DBNull.Value);
                    ...
                    command.Parameters.AddWithValue("@Dt_Extincao", escola.Dt_Extincao.HasValue ? escola.Dt_Extincao.Value : DBNull.Value);
